...
export const PIN_DEFINITIONS: Record<string, PinMeta[]> = {
  ...
  "npn": [
    { name: "collector", file_alias: undefined },
    { name: "base", file_alias: undefined },
    { name: "emitter", file_alias: undefined },
  ],
  "pnp": [
    { name: "collector", file_alias: undefined },
    { name: "base", file_alias: undefined },
  ...
  "nmos": [
    { name: "drain", file_alias: undefined },
    { name: "gate", file_alias: undefined },
    { name: "source", file_alias: undefined },
    { name: "body", file_alias: undefined },
  ],
  "pmos": [
    { name: "drain", file_alias: undefined },
    { name: "gate", file_alias: undefined },
  ...
  "opamp": [
    { name: "non_inverting", file_alias: undefined },
    { name: "inverting", file_alias: undefined },
    { name: "output", file_alias: undefined },
    { name: "v_pos", file_alias: undefined },
    { name: "v_neg", file_alias: undefined },
  ],
  "transformer": [
    { name: "primary_pos", file_alias: undefined },
    { name: "primary_neg", file_alias: undefined },
    { name: "secondary_pos", file_alias: undefined },
    { name: "secondary_neg", file_alias: undefined },
  ],
  "relay": [
    { name: "coil_pos", file_alias: undefined },
    { name: "coil_neg", file_alias: undefined },
    { name: "contact_common", file_alias: undefined },
    { name: "contact_no", file_alias: undefined },
  ],
  "dc_voltage": [
